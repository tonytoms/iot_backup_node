...
This class is executed at backup node.
This handles all the requests from controller node to the backup node.
...
class stubClass(object):
    ...
    def startBackupNodeExecution(self):
    ...
    # getBackupNodeStatus returns the node status    
    def getBackupNodeStatus(self):
        ret_status=[True,"\n Step 1(of 2) - Getting BackupNode IP","\n Step 2(of 2) - Getting Running Program List"]
        print("\n Running getBackupNodeStatus():\n")

        try:
            
            ret_status[1]=ret_status[1]+"NODE IP:"+getBNIP()
    ...
    def test(self):
        ret_status=[True,"\n Step 1(of 1) - Getting BackupNode IP "]
        print("\n Running test():")
